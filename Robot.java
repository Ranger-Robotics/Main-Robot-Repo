...
//starts the controller board
		motor1 = new Victor(0); //Motor 1 in the code is motor 0 on the pins
        motor2 = new VictorSP(1);
        motor3 = new VictorSP(2);
        motor4 = new VictorSP(3);
        motor5 = new VictorSP(4);
        motor6 = new VictorSP(5);
        motor7 = new VictorSP(6);
        motor8 = new VictorSP(7);
        motor9 = new VictorSP(8);
        DZ = (.25);
